...
**Use a caret. `^0.42.0` is correct here, and it is deliberate.**

```jsonc
"@particle-academy/agent-integrations": "^0.42.0"
```
...
the minor (npm reads `^0.42.0` as `>=0.42.0 <0.43.0`), so it gives you patches and
